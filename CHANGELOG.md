...
PR: [#321](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/321)

**February 15th 2024** – Move over to use Debian 12 based image (bookworm)

PR: [#316](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/316)

**January 9th 2024** – Move over to Gov UK Frontend 5.0 and MoJ Frontend 2.0

Note, this removed support for IE8,9,10 etc.

PR: [#297](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/297)
...
PR: [#274](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/274)

---

**November 29th 2023** – Use in-memory token store when developing locally

PR: [#273](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/273)

---

**November 6th 2023** – Add HMPPS Manage Users API to health checks

PR: [#255](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/255)
...
PR: [#252](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/252)
...
PR: [#249](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/249)
...
PR: [#247](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/247)
...
PR: [#238](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/238)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/231)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/212)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/197) 
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/178) 
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/172) 
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/170) 
...
PR: [here](https://github.com/ministryofjustice/hmpps-sentence-plan-ui-v2/pull/149)
